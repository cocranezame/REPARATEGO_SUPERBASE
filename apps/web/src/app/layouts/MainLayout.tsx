...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    primaryTo: "/crm/inbox",
    activePrefix: "/crm",
    roles: ["ADMIN", "VENDEDOR"] as RolUsuario[],
    items: [
      ...
      { label: "Dashboard", to: "/crm/dashboard", icon: <BarChart3 className="h-5 w-5" /> },
      {
        label: "Mensajería",
        to: "/crm/mensajeria",
      ...
      {
        label: "Agentes",
        to: "/crm/config/agentes",
        icon: <Bot className="h-5 w-5" />,
      },
      {
        label: "Cuentas WA",
        to: "/crm/config/wa-cuentas",
        icon: <Settings className="h-5 w-5" />,
      },
      {
        label: "Etapas",
        to: "/crm/config/etapas",
        icon: <GitBranch className="h-5 w-5" />,
      },
      {
        label: "Etiquetas",
        to: "/crm/config/etiquetas",
        icon: <Tag className="h-5 w-5" />,
      },
      {
        label: "Plantillas",
        to: "/crm/config/plantillas",
        icon: <ClipboardList className="h-5 w-5" />,
      },
      {
        label: "Bots",
